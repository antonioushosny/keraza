<x-filament-panels::page>
    ...
    <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 p-5">
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-xl flex items-center justify-center text-xl" style="background: linear-gradient(135deg, #f59e0b, #d97706);">📖</div>
                <div>
                    <h2 class="text-base font-black text-gray-950 dark:text-white">تقرير التسميع والمتابعة</h2>
                    @if($seasonName)
    ...
    @if(!$selectedClassId)
        ...
        <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 p-12 text-center mt-6">
            ...
            <h3 class="text-xl font-bold text-gray-950 dark:text-white">اختر فصل لعرض تقرير التسميع</h3>
            <p class="text-gray-500 dark:text-gray-400 mt-2 text-sm">حدد الفصل من القائمة أعلاه لرؤية درجات التسميع التفصيلية لكل مخدوم.</p>
        </div>
    ...
    @else
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
            ...
            <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 p-4 flex items-center gap-4">
                ...
                <div>
                    <div class="text-xs text-gray-500 dark:text-gray-400">الذين قاموا بالتسميع</div>
            ...
            <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 p-4 flex items-center gap-4">
                ...
                <div>
                    <div class="text-xs text-gray-500 dark:text-gray-400">بنود التسميع المتاحة</div>
                        ...
                        <tr class="bg-gray-50 dark:bg-white/5 border-b border-gray-100 dark:border-white/10">
                            ...
                            @foreach($items as $item)
                                <th class="px-4 py-4 text-xs font-black text-gray-500 dark:text-gray-400 text-center min-w-[120px]">
                                    <div>{{ $item['title'] }}</div>
                                    <div class="text-[10px] text-gray-400 dark:text-gray-500 mt-0.5">درجة العظمى: {{ $item['max_points'] }}</div>
                                </th>
                            @endforeach
                                    ...
                                    <td class="px-4 py-4 text-center">
                                        @if($scoreData)
                                            ...
                                            <div class="inline-flex flex-col items-center px-2.5 py-1 rounded-md text-xs font-bold ring-1 {{ $badgeClass }}">
                                                <span class="text-[11px]">{{ $scoreData['score'] }} / {{ $item['max_points'] }}</span>
